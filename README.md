...
___
## Svolgimento
1. Salvo in delle variabili le inforazioni acquisite da un form di input con value 
1. Uso un bottone per acquisire informazioni
1. Calcolo il prezzo del biglietto
1. Stampo il biglietto con tutte le informazioni a video usando una classe display